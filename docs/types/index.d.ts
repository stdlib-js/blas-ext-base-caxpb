...
interface Routine {
	...
	*/
	( N: number, alpha: Complex64, beta: Complex64, x: Complex64Array, strideX: number ): Complex64Array;
	...
	* // x => <Complex64Array>[ 3.0, 4.0, 7.0, 8.0, 11.0, 12.0, 15.0, 16.0 ]
	*/
	ndarray( N: number, alpha: Complex64, beta: Complex64, x: Complex64Array, strideX: number, offsetX: number ): Complex64Array;
}
